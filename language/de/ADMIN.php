...
//----------------------------------------------------------------------------//
// DASHBOARD / OVERVIEW (OverviewBody.twig)
$LNG['adm_dash_title']				= 'Dashboard';
$LNG['adm_dash_subtitle']			= '2MoonsCE Administrationszentrum';
$LNG['adm_dash_uni']				= 'Uni';
$LNG['adm_period_day']				= 'Tag';
$LNG['adm_period_week']				= 'Woche';
$LNG['adm_period_month']			= 'Monat';
$LNG['adm_period_year']				= 'Jahr';
$LNG['adm_kpi_players_online']		= 'Spieler Online';
$LNG['adm_kpi_online_total']		= 'Online / Gesamt';
$LNG['adm_kpi_details']				= 'Details';
$LNG['adm_kpi_online_15m']			= 'Online (15 Min)';
$LNG['adm_kpi_total_registered']	= 'Gesamt registriert';
$LNG['adm_kpi_banned']				= 'Gesperrt';
$LNG['adm_kpi_open_tickets']		= 'Offene Tickets';
$LNG['adm_kpi_registrations']		= 'Registrierungen';
$LNG['adm_kpi_in_period']			= 'Im Zeitraum';
$LNG['adm_kpi_new_players']			= 'Neue Spieler';
$LNG['adm_kpi_period']				= 'Zeitraum';
$LNG['adm_kpi_fleets_sent']			= 'Flotten gesendet';
$LNG['adm_kpi_fleets_info']			= 'Flotten Info';
$LNG['adm_kpi_sent']				= 'Gesendet';
$LNG['adm_kpi_flying']				= 'Aktuell fliegend';
$LNG['adm_kpi_new_alliances']		= 'Neue Allianzen';
$LNG['adm_kpi_alliances_info']		= 'Allianzen';
$LNG['adm_kpi_new_in_period']		= 'Neue im Zeitraum';
$LNG['adm_kpi_founded']				= 'Gegründet';
$LNG['adm_kpi_total']				= 'Gesamt';
$LNG['adm_kpi_combats']				= 'Kämpfe';
$LNG['adm_kpi_combat_details']		= 'Kampf-Details';
$LNG['adm_kpi_messages']			= 'Nachrichten';
$LNG['adm_kpi_multi_suspect']		= 'Multi-Verdacht';
$LNG['adm_kpi_shared_ips']			= 'Geteilte IPs';
$LNG['adm_kpi_multiaccount']		= 'Multiaccount';
$LNG['adm_kpi_affected_users']		= 'Betroffene User';
$LNG['adm_kpi_planets']				= 'Planeten';
$LNG['adm_kpi_bots_active']			= 'Bots aktiv';
$LNG['adm_kpi_last_15m']			= 'Letzte 15 Minuten';
$LNG['adm_kpi_bot_details']			= 'Bot-Details';
$LNG['adm_kpi_active_15m']			= 'Aktiv (15 Min)';
$LNG['adm_kpi_last_tick']			= 'Letzter Tick';
$LNG['adm_kpi_log_path']			= 'Log Pfad';
$LNG['adm_kpi_not_found']			= 'nicht gefunden';
$LNG['adm_top_players']				= 'Top Spieler';
$LNG['adm_top_players_sub']			= 'Top 5 (Punkte)';
$LNG['adm_top_players_uni']			= 'Highscore im Universum';
$LNG['adm_unknown']					= 'Unbekannt';
$LNG['adm_pts']						= 'Pkt';
$LNG['adm_no_top_players']			= 'Keine Top-Spieler Daten verfügbar';
$LNG['adm_active_players']			= 'Aktive Spieler';
$LNG['adm_active_players_sub']		= 'Zuletzt aktiv / Online';
$LNG['adm_online']					= 'online';
$LNG['adm_no_activity']				= 'Keine Aktivitätsdaten verfügbar';
$LNG['adm_multi_ip']				= 'Multi-IP Details';
$LNG['adm_multi_ip_sub']			= 'Verdächtige Logins nach IP (Zusammenfassung)';
$LNG['adm_multi_ip_open']			= 'Multi-IP Seite öffnen';
$LNG['adm_quick_actions']			= 'Quick Actions';
$LNG['adm_admin_tools']				= 'Admin Tools';
$LNG['adm_quick_links']				= 'Schnellzugriffe (damit du nicht suchen musst)';
$LNG['adm_qa_cache']				= 'Cache leeren';
$LNG['adm_qa_log']					= 'Admin-Log';
$LNG['adm_qa_fleets']				= 'Flotten';
$LNG['adm_qa_messages']				= 'Nachrichten';
$LNG['adm_qa_bots']					= 'Bots';
$LNG['adm_chart_activity']			= 'Aktivität / Online Verlauf';
$LNG['adm_chart_activity_sub']		= 'Aktive Spieler im Zeitraum';
$LNG['adm_chart_registrations']		= 'Registrierungen';
$LNG['adm_chart_registrations_sub']	= 'Neue Spieler im Zeitraum';
$LNG['adm_chart_fleets']			= 'Flottenstarts';
$LNG['adm_chart_fleets_sub']		= 'Gestartete Flotten im Zeitraum';
$LNG['adm_chart_combats']			= 'Kämpfe';
$LNG['adm_chart_combats_sub']		= 'Kampfberichte im Zeitraum';
$LNG['adm_chart_bots']				= 'Bots';
$LNG['adm_chart_bots_sub']			= 'Bot-Ticks im Zeitraum';
$LNG['adm_bilanz']					= 'Bilanz';
$LNG['adm_today']					= 'Heute';
$LNG['adm_bot_live_log']			= 'Bot-Aktivität (Live Log)';
$LNG['adm_bot_label']				= 'Bot';
$LNG['adm_no_bot_events']			= 'Keine Bot-Events verfügbar';
$LNG['adm_bot_log_expected']		= 'Erwartet Log-Datei unter: <code>bot_actions_debug.txt</code> oder <code>cache/bot_actions_debug.txt</code> oder <code>includes/bot_actions_debug.txt</code>.';

//----------------------------------------------------------------------------//
// EDIT BOTS (EditBots.twig)
$LNG['bot_manager_title']			= 'Bot Manager';
$LNG['bot_manager_subtitle']		= 'Verwaltung der KI-Spieler, Ressourcen-Kontingente und Strategien (PVE + PVP)';
$LNG['bot_tab_contingents']			= 'Kontingente';
$LNG['bot_tab_shiplist']			= 'Schiffsliste';
$LNG['bot_tab_strategies']			= 'Strategien / Typen';
$LNG['bot_tab_settings']			= '⚙️ Bot-Einstellungen';
$LNG['bot_tab_ai']					= '🤖 KI-Verhalten';
$LNG['bot_tab_monitor']				= '📊 Live-Monitor';
$LNG['bot_tab_analytics']			= '📈 Analytics';
$LNG['bot_tab_personalities']		= '🎭 Persönlichkeiten';
$LNG['bot_tab_devtools']			= '🛠️ Dev-Tools';
$LNG['bot_tab_accounts']			= 'Bot-Accounts';
$LNG['bot_tab_planets']				= 'Bot-Planeten';
$LNG['bot_tab_generator']			= 'Generator';
$LNG['bot_settings_title']			= '⚙️ Globale Bot-Einstellungen';
$LNG['bot_settings_parallelism']	= '⚡ Parallelität & Performance';
$LNG['bot_settings_bots_per_tick']	= 'Anzahl paralleler Bots pro Cronjob-Lauf';
$LNG['bot_settings_bots_hint']		= 'Wie viele Bots sollen <b>gleichzeitig</b> aktiv sein? (1-50)';
$LNG['bot_settings_std']			= 'Standard';
$LNG['bot_settings_more_faster']	= 'Mehr = alle Bots kommen schneller dran';
$LNG['bot_settings_min_online']		= 'Min. Bots online (Nachts)';
$LNG['bot_settings_min_hint']		= 'Mindestens X Bots erscheinen online (00:00-06:00)';
$LNG['bot_settings_max_online']		= 'Max. Bots online (Prime-Time)';
$LNG['bot_settings_max_hint']		= 'Maximal X Bots erscheinen online (18:00-00:00)';
$LNG['bot_settings_max_actions']	= 'Max. Aktionen pro Bot-Tick';
$LNG['bot_settings_max_actions_hint'] = 'Wie viele Aktionen darf ein Bot pro Tick machen?';
$LNG['bot_settings_timing']			= '🕐 Timing & Delays';
$LNG['bot_settings_min_delay']		= 'Min. Delay zwischen Bot-Ticks (Sekunden)';
$LNG['bot_settings_min_delay_hint']	= 'Mindestens X Sekunden zwischen zwei Aktionen desselben Bots';
$LNG['bot_settings_max_delay']		= 'Max. Delay zwischen Bot-Ticks (Sekunden)';
$LNG['bot_settings_max_delay_hint']	= 'Maximal X Sekunden zwischen zwei Aktionen desselben Bots';
$LNG['bot_settings_crash_delay']	= 'Crash-Delay (Sekunden)';
$LNG['bot_settings_crash_hint']		= 'Bei Bot-Crash: Nächster Versuch erst nach X Sekunden';
$LNG['bot_settings_activity']		= '🎯 Aktivitätsmodus';
$LNG['bot_settings_random_timing']	= 'Zufällige Timing-Variation (+/- 20%)';
$LNG['bot_settings_random_hint']	= 'Bots ticken nicht exakt nach Schema → wirkt menschlicher';
$LNG['bot_settings_spread']			= 'Bots zeitlich verteilen (Spread)';
$LNG['bot_settings_spread_hint']	= 'Nicht alle Bots auf einmal starten → reduziert Last-Spitzen';
$LNG['bot_settings_save']			= '💾 Einstellungen Speichern';
$LNG['bot_ai_title']				= '🤖 Bot KI-Verhalten Konfiguration';
$LNG['bot_ai_economy']				= '💰 Wirtschafts-Priorität';
$LNG['bot_ai_build_strategy']		= 'Bau-Strategie';
$LNG['bot_ai_balanced']				= 'Ausgewogen (Mine→Kraftwerk→Speicher)';
$LNG['bot_ai_metal_rush']			= 'Metall-Rush (Metallmine Priorität)';
$LNG['bot_ai_crystal_rush']			= 'Kristall-Rush (Kristallmine Priorität)';
$LNG['bot_ai_energy_first']			= 'Energie Zuerst (Solar/Fusion)';
$LNG['bot_ai_infrastructure']		= 'Infrastruktur (Labor/Werft)';
$LNG['bot_ai_research_strategy']	= 'Forschungs-Strategie';
$LNG['bot_ai_research_economy']		= 'Wirtschaft (Energie/Plasma/Astro)';
$LNG['bot_ai_research_military']	= 'Militär (Waffen/Schilde/Panzerung)';
$LNG['bot_ai_research_drive']		= 'Antriebstech (Geschwindigkeit)';
$LNG['bot_ai_research_balanced']	= 'Ausgewogener Mix';
$LNG['bot_ai_shipyard_focus']		= 'Werft-Fokus';
$LNG['bot_ai_cargo']				= 'Transporter (Transport)';
$LNG['bot_ai_recycler']				= 'Recycler (Trümmerfeld)';
$LNG['bot_ai_fighter']				= 'Jäger (Kampf)';
$LNG['bot_ai_mixed_fleet']			= 'Gemischte Flotte';
$LNG['bot_ai_min_resources']		= 'Min. Ressourcen vor Upgrade';
$LNG['bot_ai_min_res_hint']			= 'Wartet bis genug Ressourcen vorhanden sind';
$LNG['bot_ai_fleet']				= '🚀 Flotten-Verhalten';
$LNG['bot_ai_expo_freq']			= 'Expeditions-Frequenz';
$LNG['bot_ai_never']				= 'Niemals';
$LNG['bot_ai_when_idle']			= 'Wenn untätig (Standard)';
$LNG['bot_ai_aggressive']			= 'Aggressiv (Alle Slots)';
$LNG['bot_ai_auto_recycle']			= 'Auto-Recycling eigener TF';
$LNG['bot_ai_always']				= 'Immer (Sofort)';
$LNG['bot_ai_when_worth']			= 'Wenn lohnenswert (>10k)';
$LNG['bot_ai_fleet_size']			= 'Flottengröße pro Mission';
$LNG['bot_ai_fleet_size_hint']		= '% der Flotte pro Mission (10-100%)';
$LNG['bot_ai_mission_dist']			= 'Bevorzugte Missions-Distanz';
$LNG['bot_ai_dist_hint']			= 'Max. Systeme Entfernung';
$LNG['bot_ai_advanced']				= '⚙️ Erweiterte KI';
$LNG['bot_ai_decision_speed']		= 'Entscheidungsgeschwindigkeit';
$LNG['bot_ai_slow']					= 'Langsam (Konservativ)';
$LNG['bot_ai_normal']				= 'Normal';
$LNG['bot_ai_fast']					= 'Schnell (Aggressiv)';
$LNG['bot_ai_risk']					= 'Risiko-Toleranz';
$LNG['bot_ai_risk_hint']			= 'Wie aggressiv bei Raids/Expos';
$LNG['bot_ai_ress_prio']			= 'Ressourcen-Priorität';
$LNG['bot_ai_ress_prio_hint']		= 'Gewichtung beim Ressourcen-Management';
$LNG['bot_ai_auto_research']		= 'Auto-Forschung (Automatische Tech-Warteschlange)';
$LNG['bot_ai_fleet_save']			= 'Smart Fleet Save (Bei Gefahr zurückrufen)';
$LNG['bot_ai_raids']				= 'Opportunistische Raids (Schwache Ziele nutzen)';
$LNG['bot_ai_save']					= '💾 KI-Konfiguration Speichern';
$LNG['bot_monitor_title']			= '📊 Live Bot-Monitor';
$LNG['bot_monitor_active']			= 'Aktive Bots';
$LNG['bot_monitor_building']		= 'Bau-Warteschlange';
$LNG['bot_monitor_research']		= 'Forschungs-Warteschlange';
$LNG['bot_monitor_fleets']			= 'Flotten im Weltall';
$LNG['bot_monitor_waiting']			= 'Warte auf Bot-Aktivität...';
$LNG['bot_analytics_title']			= '📈 Bot Analytics & Performance';
$LNG['bot_analytics_actions']		= 'Gesamt-Aktionen (24h)';
$LNG['bot_analytics_ress_hour']		= 'Ressourcen/Stunde';
$LNG['bot_analytics_success']		= 'Erfolgsquote';
$LNG['bot_analytics_fleets']		= 'Aktive Flotten';
$LNG['bot_analytics_heatmap']		= '🔥 Aktivitäts-Heatmap (24 Stunden)';
$LNG['bot_analytics_flow']			= '💎 Ressourcen-Flow (Letzte 24h)';
$LNG['bot_analytics_raid_title']	= '🎯 Raid Erfolgsquote';
$LNG['bot_analytics_successful']	= 'Erfolgreich';
$LNG['bot_analytics_total']			= 'Gesamt';
$LNG['bot_analytics_expo_title']	= '🌌 Expeditions Erfolgsquote';
$LNG['bot_analytics_top10']			= '🏆 Top 10 Aktivste Bots (24h)';
$LNG['bot_analytics_rank']			= 'Rang';
$LNG['bot_analytics_botname']		= 'Bot Name';
$LNG['bot_analytics_actions_col']	= 'Aktionen';
$LNG['bot_analytics_ress_won']		= 'Ress gewonnen';
$LNG['bot_analytics_fleets_col']	= 'Flotten';
$LNG['bot_personality_title']		= '🎭 Bot-Persönlichkeiten';
$LNG['bot_personality_subtitle']	= 'Jeder Bot hat eine Persönlichkeit die sein Verhalten bestimmt. Die Verteilung wird beim Erstellen zufällig zugewiesen.';
$LNG['bot_personality_count']		= 'Anzahl Bots';
$LNG['bot_personality_mines']		= 'Minen';
$LNG['bot_personality_energy']		= 'Energie';
$LNG['bot_personality_research']	= 'Forschung';
$LNG['bot_personality_fleets']		= 'Flotten';
$LNG['bot_personality_defense']		= 'Verteidigung';
$LNG['bot_personality_aggression']	= 'Aggression';
$LNG['bot_personality_redistribute'] = '⚠️ Persönlichkeiten neu verteilen';
$LNG['bot_personality_redist_hint']	= 'Weist allen Bots neue zufällige Persönlichkeiten zu. Dies überschreibt alle bisherigen Zuweisungen.';
$LNG['bot_personality_redist_confirm'] = 'Wirklich alle Persönlichkeiten neu zuweisen?';
$LNG['bot_personality_redist_btn']	= '🎲 Zufällig neu verteilen';
$LNG['bot_devtools_title']			= '🛠️ Entwickler-Tools (Gefährlich!)';
$LNG['bot_devtools_boost']			= '⚡ Quick Boost für alle Bots';
$LNG['bot_devtools_boost_confirm']	= 'Alle Bots auf diese Level setzen?';
$LNG['bot_devtools_mines']			= 'Minen-Level (1/2/3)';
$LNG['bot_devtools_power']			= 'Kraftwerk-Level (4/12)';
$LNG['bot_devtools_astro']			= 'Astrophysik-Level (124)';
$LNG['bot_devtools_boost_btn']		= '🚀 Alle Bots boosten';
$LNG['bot_devtools_inject']			= '💎 Ressourcen-Injektion';
$LNG['bot_devtools_inject_btn']		= '💰 Ressourcen injizieren';
$LNG['bot_devtools_spawn']			= '🛸 Instant Flotten-Spawn';
$LNG['bot_devtools_spawn_btn']		= '🛸 Flotte auf alle Bots spawnen';
$LNG['bot_devtools_danger']			= '⚠️ Gefahrenzone';
$LNG['bot_devtools_reset_confirm']	= 'ACHTUNG: Alle Bots werden gelöscht und neu erstellt!';
$LNG['bot_devtools_reset_hint']		= 'Löscht ALLE Bots und erstellt sie komplett neu.';
$LNG['bot_devtools_reset_btn']		= '🔥 Alle Bots zurücksetzen';
$LNG['bot_devtools_trigger_confirm'] = 'Alle Bot next_fleet_action auf JETZT setzen?';
$LNG['bot_devtools_trigger_hint']	= 'Alle Bots sofort aktivieren (nächster Tick = jetzt)';
$LNG['bot_devtools_trigger_btn']	= '⚡ Alle Bots JETZT triggern';
$LNG['bot_contingents_title']		= 'Ressourcen & Flotten Kontingente';
$LNG['bot_active_fleets_title']		= 'Aktive Flottenbewegungen';
$LNG['bot_strategies_title']		= 'Strategien Konfiguration (PVE + PVP steuerbar)';
$LNG['bot_accounts_title']			= 'Aktive Bot Accounts';
$LNG['bot_delete_confirm']			= 'Account #ID# wirklich löschen?';
$LNG['bot_generator_subtitle']		= 'Erstellt zufällige Bots basierend auf den Strategien';
$LNG['bot_generator_count']			= 'Anzahl der Bots';
$LNG['bot_generator_planets']		= 'Planeten pro Bot';
$LNG['bot_generator_start']			= 'Bots Generieren Starten';
$LNG['bot_devtools_ship_202']		= 'Kleiner Transporter (202)';
$LNG['bot_devtools_ship_203']		= 'Großer Transporter (203)';
$LNG['bot_devtools_ship_204']		= 'Leichter Jäger (204)';

//----------------------------------------------------------------------------//
// PLUGIN ADMIN (PluginAdminPage.twig)
$LNG['plg_installed']				= 'Installiert';
$LNG['plg_active']					= 'Aktiv';
$LNG['plg_inactive']				= 'Inaktiv';
$LNG['plg_available']				= 'Verfügbar';
$LNG['plg_search']					= 'Plugin suchen…';
$LNG['plg_filter_all']				= 'Alle';
$LNG['plg_filter_active']			= 'Aktiv';
$LNG['plg_filter_inactive']			= 'Inaktiv';
$LNG['plg_filter_new']				= 'Neu verfügbar';
$LNG['plg_section_installed']		= 'Installierte Plugins';
$LNG['plg_none_installed']			= 'Keine Plugins installiert. Lade ein ZIP hoch oder installiere ein gefundenes Plugin.';
$LNG['plg_deactivate']				= 'Deaktivieren';
$LNG['plg_activate']				= 'Aktivieren';
$LNG['plg_admin_panel']				= 'Admin-Panel';
$LNG['plg_uninstall']				= 'Deinstallieren';
$LNG['plg_uninstall_confirm']		= 'Plugin \'{name}\' wirklich deinstallieren?\nDieser Vorgang kann nicht rückgängig gemacht werden.';
$LNG['plg_section_discover']		= 'Gefunden – nicht installiert';
$LNG['plg_not_installed']			= 'Nicht installiert';
$LNG['plg_install']					= 'Installieren';
$LNG['plg_upload_section']			= 'Plugin per ZIP installieren';
$LNG['plg_upload_title']			= 'ZIP hierher ziehen oder klicken zum Auswählen';
$LNG['plg_upload_sub']				= 'Nur <strong>.zip</strong> — muss <code>manifest.json</code> mit <code>id</code>, <code>name</code>, <code>version</code> enthalten';
$LNG['plg_upload_btn']				= 'Hochladen & Installieren';
$LNG['plg_hooks_title']				= 'Registrierte Hooks';
$LNG['plg_no_actions']				= 'Keine Actions registriert.';
$LNG['plg_no_filters']				= 'Keine Filter registriert.';
$LNG['plg_modal_cancel']			= 'Abbrechen';
$LNG['plg_modal_save']				= 'Speichern';
$LNG['plg_faq_open']				= '▼ Aufklappen';
$LNG['plg_faq_close']				= '▲ Zuklappen';
$LNG['plg_copy']					= 'Kopieren';
$LNG['plg_copied']					= 'Kopiert!';
$LNG['plg_hooks_expand']			= '▼ Aufklappen';

//----------------------------------------------------------------------------//
// SYSTEM DEBUG (SystemDebugPage.twig)
$LNG['sdp_safe_cleared']			= 'Safe-Mode Lock erfolgreich entfernt. Plugins werden beim nächsten Request wieder geladen.';
$LNG['sdp_safe_active']				= 'SAFE-MODE LOCK aktiv';
$LNG['sdp_safe_all_disabled']		= 'ALLE PLUGINS DEAKTIVIERT';
$LNG['sdp_safe_since']				= 'Seit:';
$LNG['sdp_safe_reason']				= 'Grund:';
$LNG['sdp_safe_remove_confirm']		= 'Safe-Mode Lock wirklich entfernen? Alle Plugins werden beim nächsten Request wieder geladen.';
$LNG['sdp_safe_remove_btn']			= '✖ Lock entfernen & Plugins wieder aktivieren';
$LNG['sdp_tab_plugins']				= 'Plugins';
$LNG['sdp_tab_hooks']				= 'Hooks';
$LNG['sdp_tab_assets']				= 'Assets';
$LNG['sdp_tab_modules']				= 'Modules';
$LNG['sdp_no_plugins']				= 'Keine Plugins in der Datenbank gefunden.';
$LNG['sdp_no_hooks']				= 'Keine Hooks registriert.';
$LNG['sdp_no_assets']				= 'Keine Assets registriert.';
$LNG['sdp_copy']					= 'Kopieren';
$LNG['sdp_copied']					= '✓ Kopiert';
$LNG['sdp_plugin_search']			= 'Plugin suchen (ID, Name, Typ)…';
$LNG['sdp_hook_search']				= 'Hook suchen (Name, Typ, Callback)…';
$LNG['sdp_asset_search']			= 'Asset suchen (Pfad, Plugin-ID)…';
$LNG['sdp_module_search']			= 'Modul suchen (ID, Klasse, Origin)…';
$LNG['sdp_no_module_manager']		= 'ModuleManager nicht geladen. Das v2 Full Modular Gameplay Engine System ist in dieser Umgebung nicht aktiv. Stelle sicher, dass <code>includes/classes/ModuleManager.class.php</code> in <code>common.php</code> eingebunden ist.';
$LNG['sdp_no_modules']				= 'Keine Module registriert.';

//----------------------------------------------------------------------------//
// SHOW INFORMATION (ShowInformationPage.twig)
$LNG['si_title']					= 'Server Informationen';
$LNG['si_subtitle']					= 'Technische Details und Umgebungsvariablen';
$LNG['si_system_env']				= 'System Umgebung';
$LNG['si_db_game']					= 'Datenbank & Spiel';
$LNG['si_paths']					= 'Pfade & Einstellungen';
$LNG['si_json']						= 'JSON Verfügbar';
$LNG['si_bcmath']					= 'BCMath Verfügbar';
$LNG['si_curl']						= 'cURL Verfügbar';
$LNG['si_game_addr']				= 'Game Adresse';
$LNG['si_game_path']				= 'Game Pfad';
$LNG['si_bug_report']				= 'Bug Report Template';
$LNG['si_copy_btn']					= 'Kopieren';
$LNG['si_copied_alert']				= 'In die Zwischenablage kopiert!';

//----------------------------------------------------------------------------//
// SEND MESSAGES (SendMessagesPage.twig)
$LNG['sm_success_check']			= 'erfolgreich';
$LNG['sm_sent_check']				= 'gesendet';
$LNG['sm_next_btn']					= 'Weiter';
$LNG['sm_error_title']				= '❌ FEHLER';
$LNG['sm_error_msg']				= 'Die Nachricht konnte nicht übertragen werden.';
$LNG['sm_retry']					= 'Wiederholen';
$LNG['sm_cancel']					= 'Abbrechen';
$LNG['sm_bb_quote']					= 'Zitat';
$LNG['sm_bb_link']					= 'Link';
$LNG['sm_bb_image']					= 'Bild';
$LNG['sm_placeholder']				= 'Nachricht hier eingeben...';

//----------------------------------------------------------------------------//
// VARIOUS ADMIN SMALL STRINGS
$LNG['adm_select_area']				= 'Wähle einen Bereich zum Bearbeiten';
$LNG['adm_mines_plants']			= 'Minen & Anlagen';
$LNG['adm_combat_ships']			= 'Kampf- & Zivilschiffe';
$LNG['adm_guns_domes']				= 'Geschütze & Schildkuppeln';
$LNG['adm_tech_drives']				= 'Technologien & Antriebe';
$LNG['adm_dm_officers']				= 'DM-Offiziere & Boni';
$LNG['adm_res_dm']					= 'Met/Kris/Deut & DM';
$LNG['adm_planet_fields']			= 'Felder, Namen & Löschen';
$LNG['adm_alliance_members']		= 'Mitglieder & Texte';
$LNG['adm_email_pw_name']			= 'Email, Passwort & Namen';
$LNG['adm_buildings_edit_hint']		= 'Gebäudestufen manipulieren';
$LNG['adm_select_player']			= 'Wähle einen Spieler aus der Liste oder suche direkt.';
$LNG['adm_select_class']			= '-- Klasse wählen --';
$LNG['adm_news_color']				= 'Farbe';
$LNG['adm_news_size']				= 'Größe';
$LNG['adm_select_btn']				= 'AUSWÄHLEN';
$LNG['adm_total']					= 'Gesamt';