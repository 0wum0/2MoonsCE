...
$LNG['du_not_tables_selected'] = 'You have not selected any table to backup!';

//----------------------------------------------------------------------------//
// DASHBOARD / OVERVIEW (OverviewBody.twig)
$LNG['adm_dash_title']				= 'Dashboard';
$LNG['adm_dash_subtitle']			= '2MoonsCE Administration Center';
$LNG['adm_dash_uni']				= 'Uni';
$LNG['adm_period_day']				= 'Day';
$LNG['adm_period_week']				= 'Week';
$LNG['adm_period_month']			= 'Month';
$LNG['adm_period_year']				= 'Year';
$LNG['adm_kpi_players_online']		= 'Players Online';
$LNG['adm_kpi_online_total']		= 'Online / Total';
$LNG['adm_kpi_details']				= 'Details';
$LNG['adm_kpi_online_15m']			= 'Online (15 min)';
$LNG['adm_kpi_total_registered']	= 'Total registered';
$LNG['adm_kpi_banned']				= 'Banned';
$LNG['adm_kpi_open_tickets']		= 'Open Tickets';
$LNG['adm_kpi_registrations']		= 'Registrations';
$LNG['adm_kpi_in_period']			= 'In period';
$LNG['adm_kpi_new_players']			= 'New players';
$LNG['adm_kpi_period']				= 'Period';
$LNG['adm_kpi_fleets_sent']			= 'Fleets sent';
$LNG['adm_kpi_fleets_info']			= 'Fleet info';
$LNG['adm_kpi_sent']				= 'Sent';
$LNG['adm_kpi_flying']				= 'Currently flying';
$LNG['adm_kpi_new_alliances']		= 'New alliances';
$LNG['adm_kpi_alliances_info']		= 'Alliances';
$LNG['adm_kpi_new_in_period']		= 'New in period';
$LNG['adm_kpi_founded']				= 'Founded';
$LNG['adm_kpi_total']				= 'Total';
$LNG['adm_kpi_combats']				= 'Combats';
$LNG['adm_kpi_combat_details']		= 'Combat details';
$LNG['adm_kpi_messages']			= 'Messages';
$LNG['adm_kpi_multi_suspect']		= 'Multi-account suspect';
$LNG['adm_kpi_shared_ips']			= 'Shared IPs';
$LNG['adm_kpi_multiaccount']		= 'Multiaccount';
$LNG['adm_kpi_affected_users']		= 'Affected users';
$LNG['adm_kpi_planets']				= 'Planets';
$LNG['adm_kpi_bots_active']			= 'Bots active';
$LNG['adm_kpi_last_15m']			= 'Last 15 minutes';
$LNG['adm_kpi_bot_details']			= 'Bot details';
$LNG['adm_kpi_active_15m']			= 'Active (15 min)';
$LNG['adm_kpi_last_tick']			= 'Last tick';
$LNG['adm_kpi_log_path']			= 'Log path';
$LNG['adm_kpi_not_found']			= 'not found';
$LNG['adm_top_players']				= 'Top Players';
$LNG['adm_top_players_sub']			= 'Top 5 (Points)';
$LNG['adm_top_players_uni']			= 'Universe highscore';
$LNG['adm_unknown']					= 'Unknown';
$LNG['adm_pts']						= 'pts';
$LNG['adm_no_top_players']			= 'No top player data available';
$LNG['adm_active_players']			= 'Active players';
$LNG['adm_active_players_sub']		= 'Last active / Online';
$LNG['adm_online']					= 'online';
$LNG['adm_no_activity']				= 'No activity data available';
$LNG['adm_multi_ip']				= 'Multi-IP details';
$LNG['adm_multi_ip_sub']			= 'Suspicious logins by IP (summary)';
$LNG['adm_multi_ip_open']			= 'Open Multi-IP page';
$LNG['adm_quick_actions']			= 'Quick Actions';
$LNG['adm_admin_tools']				= 'Admin Tools';
$LNG['adm_quick_links']				= 'Quick access links';
$LNG['adm_qa_cache']				= 'Clear cache';
$LNG['adm_qa_log']					= 'Admin log';
$LNG['adm_qa_fleets']				= 'Fleets';
$LNG['adm_qa_messages']				= 'Messages';
$LNG['adm_qa_bots']					= 'Bots';
$LNG['adm_chart_activity']			= 'Activity / Online history';
$LNG['adm_chart_activity_sub']		= 'Active players in period';
$LNG['adm_chart_registrations']		= 'Registrations';
$LNG['adm_chart_registrations_sub']	= 'New players in period';
$LNG['adm_chart_fleets']			= 'Fleet launches';
$LNG['adm_chart_fleets_sub']		= 'Fleets launched in period';
$LNG['adm_chart_combats']			= 'Combats';
$LNG['adm_chart_combats_sub']		= 'Combat reports in period';
$LNG['adm_chart_bots']				= 'Bots';
$LNG['adm_chart_bots_sub']			= 'Bot ticks in period';
$LNG['adm_bilanz']					= 'Summary';
$LNG['adm_today']					= 'Today';
$LNG['adm_bot_live_log']			= 'Bot activity (live log)';
$LNG['adm_bot_label']				= 'Bot';
$LNG['adm_no_bot_events']			= 'No bot events available';
$LNG['adm_bot_log_expected']		= 'Expected log file at: <code>bot_actions_debug.txt</code> or <code>cache/bot_actions_debug.txt</code> or <code>includes/bot_actions_debug.txt</code>.';

//----------------------------------------------------------------------------//
// EDIT BOTS (EditBots.twig)
$LNG['bot_manager_title']			= 'Bot Manager';
$LNG['bot_manager_subtitle']		= 'Management of AI players, resource quotas and strategies (PVE + PVP)';
$LNG['bot_tab_contingents']			= 'Quotas';
$LNG['bot_tab_shiplist']			= 'Ship List';
$LNG['bot_tab_strategies']			= 'Strategies / Types';
$LNG['bot_tab_settings']			= '⚙️ Bot Settings';
$LNG['bot_tab_ai']					= '🤖 AI Behaviour';
$LNG['bot_tab_monitor']				= '📊 Live Monitor';
$LNG['bot_tab_analytics']			= '📈 Analytics';
$LNG['bot_tab_personalities']		= '🎭 Personalities';
$LNG['bot_tab_devtools']			= '🛠️ Dev Tools';
$LNG['bot_tab_accounts']			= 'Bot Accounts';
$LNG['bot_tab_planets']				= 'Bot Planets';
$LNG['bot_tab_generator']			= 'Generator';
$LNG['bot_settings_title']			= '⚙️ Global Bot Settings';
$LNG['bot_settings_parallelism']	= '⚡ Parallelism & Performance';
$LNG['bot_settings_bots_per_tick']	= 'Number of parallel bots per cronjob run';
$LNG['bot_settings_bots_hint']		= 'How many bots should be <b>simultaneously</b> active? (1-50)';
$LNG['bot_settings_std']			= 'Default';
$LNG['bot_settings_more_faster']	= 'More = all bots get their turn faster';
$LNG['bot_settings_min_online']		= 'Min. bots online (Night)';
$LNG['bot_settings_min_hint']		= 'At least X bots appear online (00:00-06:00)';
$LNG['bot_settings_max_online']		= 'Max. bots online (Prime-Time)';
$LNG['bot_settings_max_hint']		= 'At most X bots appear online (18:00-00:00)';
$LNG['bot_settings_max_actions']	= 'Max. actions per bot tick';
$LNG['bot_settings_max_actions_hint'] = 'How many actions may a bot perform per tick?';
$LNG['bot_settings_timing']			= '🕐 Timing & Delays';
$LNG['bot_settings_min_delay']		= 'Min. delay between bot ticks (seconds)';
$LNG['bot_settings_min_delay_hint']	= 'At least X seconds between two actions of the same bot';
$LNG['bot_settings_max_delay']		= 'Max. delay between bot ticks (seconds)';
$LNG['bot_settings_max_delay_hint']	= 'At most X seconds between two actions of the same bot';
$LNG['bot_settings_crash_delay']	= 'Crash delay (seconds)';
$LNG['bot_settings_crash_hint']		= 'On bot crash: next attempt only after X seconds';
$LNG['bot_settings_activity']		= '🎯 Activity Mode';
$LNG['bot_settings_random_timing']	= 'Random timing variation (+/- 20%)';
$LNG['bot_settings_random_hint']	= 'Bots do not tick exactly on schedule → appears more human';
$LNG['bot_settings_spread']			= 'Spread bots over time';
$LNG['bot_settings_spread_hint']	= 'Do not start all bots at once → reduces load spikes';
$LNG['bot_settings_save']			= '💾 Save Settings';
$LNG['bot_ai_title']				= '🤖 Bot AI Behaviour Configuration';
$LNG['bot_ai_economy']				= '💰 Economy Priority';
$LNG['bot_ai_build_strategy']		= 'Build Strategy';
$LNG['bot_ai_balanced']				= 'Balanced (Mine→Power→Storage)';
$LNG['bot_ai_metal_rush']			= 'Metal Rush (Metal mine priority)';
$LNG['bot_ai_crystal_rush']			= 'Crystal Rush (Crystal mine priority)';
$LNG['bot_ai_energy_first']			= 'Energy First (Solar/Fusion)';
$LNG['bot_ai_infrastructure']		= 'Infrastructure (Lab/Shipyard)';
$LNG['bot_ai_research_strategy']	= 'Research Strategy';
$LNG['bot_ai_research_economy']		= 'Economy (Energy/Plasma/Astro)';
$LNG['bot_ai_research_military']	= 'Military (Weapons/Shields/Armour)';
$LNG['bot_ai_research_drive']		= 'Drive tech (Speed)';
$LNG['bot_ai_research_balanced']	= 'Balanced mix';
$LNG['bot_ai_shipyard_focus']		= 'Shipyard Focus';
$LNG['bot_ai_cargo']				= 'Cargo (Transport)';
$LNG['bot_ai_recycler']				= 'Recycler (Debris field)';
$LNG['bot_ai_fighter']				= 'Fighter (Combat)';
$LNG['bot_ai_mixed_fleet']			= 'Mixed fleet';
$LNG['bot_ai_min_resources']		= 'Min. resources before upgrade';
$LNG['bot_ai_min_res_hint']			= 'Waits until enough resources are available';
$LNG['bot_ai_fleet']				= '🚀 Fleet Behaviour';
$LNG['bot_ai_expo_freq']			= 'Expedition frequency';
$LNG['bot_ai_never']				= 'Never';
$LNG['bot_ai_when_idle']			= 'When idle (default)';
$LNG['bot_ai_aggressive']			= 'Aggressive (all slots)';
$LNG['bot_ai_auto_recycle']			= 'Auto-recycling own DF';
$LNG['bot_ai_always']				= 'Always (immediately)';
$LNG['bot_ai_when_worth']			= 'When worthwhile (>10k)';
$LNG['bot_ai_fleet_size']			= 'Fleet size per mission';
$LNG['bot_ai_fleet_size_hint']		= '% of fleet per mission (10-100%)';
$LNG['bot_ai_mission_dist']			= 'Preferred mission distance';
$LNG['bot_ai_dist_hint']			= 'Max. systems distance';
$LNG['bot_ai_advanced']				= '⚙️ Advanced AI';
$LNG['bot_ai_decision_speed']		= 'Decision speed';
$LNG['bot_ai_slow']					= 'Slow (Conservative)';
$LNG['bot_ai_normal']				= 'Normal';
$LNG['bot_ai_fast']					= 'Fast (Aggressive)';
$LNG['bot_ai_risk']					= 'Risk tolerance';
$LNG['bot_ai_risk_hint']			= 'How aggressive in raids/expos';
$LNG['bot_ai_ress_prio']			= 'Resource priority';
$LNG['bot_ai_ress_prio_hint']		= 'Weighting in resource management';
$LNG['bot_ai_auto_research']		= 'Auto research (automatic tech queue)';
$LNG['bot_ai_fleet_save']			= 'Smart Fleet Save (recall on danger)';
$LNG['bot_ai_raids']				= 'Opportunistic raids (exploit weak targets)';
$LNG['bot_ai_save']					= '💾 Save AI Configuration';
$LNG['bot_monitor_title']			= '📊 Live Bot Monitor';
$LNG['bot_monitor_active']			= 'Active Bots';
$LNG['bot_monitor_building']		= 'Build Queue';
$LNG['bot_monitor_research']		= 'Research Queue';
$LNG['bot_monitor_fleets']			= 'Fleets in Space';
$LNG['bot_monitor_waiting']			= 'Waiting for bot activity...';
$LNG['bot_analytics_title']			= '📈 Bot Analytics & Performance';
$LNG['bot_analytics_actions']		= 'Total Actions (24h)';
$LNG['bot_analytics_ress_hour']		= 'Resources/Hour';
$LNG['bot_analytics_success']		= 'Success Rate';
$LNG['bot_analytics_fleets']		= 'Active Fleets';
$LNG['bot_analytics_heatmap']		= '🔥 Activity Heatmap (24 hours)';
$LNG['bot_analytics_flow']			= '💎 Resource Flow (Last 24h)';
$LNG['bot_analytics_raid_title']	= '🎯 Raid Success Rate';
$LNG['bot_analytics_successful']	= 'Successful';
$LNG['bot_analytics_total']			= 'Total';
$LNG['bot_analytics_expo_title']	= '🌌 Expedition Success Rate';
$LNG['bot_analytics_top10']			= '🏆 Top 10 Most Active Bots (24h)';
$LNG['bot_analytics_rank']			= 'Rank';
$LNG['bot_analytics_botname']		= 'Bot Name';
$LNG['bot_analytics_actions_col']	= 'Actions';
$LNG['bot_analytics_ress_won']		= 'Resources gained';
$LNG['bot_analytics_fleets_col']	= 'Fleets';
$LNG['bot_personality_title']		= '🎭 Bot Personalities';
$LNG['bot_personality_subtitle']	= 'Each bot has a personality that determines its behaviour. Distribution is randomly assigned on creation.';
$LNG['bot_personality_count']		= 'Bot Count';
$LNG['bot_personality_mines']		= 'Mines';
$LNG['bot_personality_energy']		= 'Energy';
$LNG['bot_personality_research']	= 'Research';
$LNG['bot_personality_fleets']		= 'Fleets';
$LNG['bot_personality_defense']		= 'Defense';
$LNG['bot_personality_aggression']	= 'Aggression';
$LNG['bot_personality_redistribute'] = '⚠️ Redistribute personalities';
$LNG['bot_personality_redist_hint']	= 'Assigns new random personalities to all bots. This overwrites all existing assignments.';
$LNG['bot_personality_redist_confirm'] = 'Really reassign all personalities?';
$LNG['bot_personality_redist_btn']	= '🎲 Randomly redistribute';
$LNG['bot_devtools_title']			= '🛠️ Developer Tools (Dangerous!)';
$LNG['bot_devtools_boost']			= '⚡ Quick Boost for all Bots';
$LNG['bot_devtools_boost_confirm']	= 'Set all bots to these levels?';
$LNG['bot_devtools_mines']			= 'Mine Level (1/2/3)';
$LNG['bot_devtools_power']			= 'Power Plant Level (4/12)';
$LNG['bot_devtools_astro']			= 'Astrophysics Level (124)';
$LNG['bot_devtools_boost_btn']		= '🚀 Boost all Bots';
$LNG['bot_devtools_inject']			= '💎 Resource Injection';
$LNG['bot_devtools_inject_btn']		= '💰 Inject Resources';
$LNG['bot_devtools_spawn']			= '🛸 Instant Fleet Spawn';
$LNG['bot_devtools_spawn_btn']		= '🛸 Spawn fleet on all Bots';
$LNG['bot_devtools_danger']			= '⚠️ Danger Zone';
$LNG['bot_devtools_reset_confirm']	= 'WARNING: All bots will be deleted and recreated!';
$LNG['bot_devtools_reset_hint']		= 'Deletes ALL bots and recreates them from scratch.';
$LNG['bot_devtools_reset_btn']		= '🔥 Reset all Bots';
$LNG['bot_devtools_trigger_confirm'] = 'Set all bot next_fleet_action to NOW?';
$LNG['bot_devtools_trigger_hint']	= 'Activate all bots immediately (next tick = now)';
$LNG['bot_devtools_trigger_btn']	= '⚡ Trigger all Bots NOW';
$LNG['bot_contingents_title']		= 'Resource & Fleet Quotas';
$LNG['bot_active_fleets_title']		= 'Active Fleet Movements';
$LNG['bot_strategies_title']		= 'Strategy Configuration (PVE + PVP controllable)';
$LNG['bot_accounts_title']			= 'Active Bot Accounts';
$LNG['bot_delete_confirm']			= 'Really delete account #ID#?';
$LNG['bot_generator_subtitle']		= 'Creates random bots based on the strategies';
$LNG['bot_generator_count']			= 'Number of bots';
$LNG['bot_generator_planets']		= 'Planets per bot';
$LNG['bot_generator_start']			= 'Start Generating Bots';
$LNG['bot_devtools_ship_202']		= 'Small Cargo (202)';
$LNG['bot_devtools_ship_203']		= 'Large Cargo (203)';
$LNG['bot_devtools_ship_204']		= 'Light Fighter (204)';

//----------------------------------------------------------------------------//
// PLUGIN ADMIN (PluginAdminPage.twig)
$LNG['plg_installed']				= 'Installed';
$LNG['plg_active']					= 'Active';
$LNG['plg_inactive']				= 'Inactive';
$LNG['plg_available']				= 'Available';
$LNG['plg_search']					= 'Search plugin…';
$LNG['plg_filter_all']				= 'All';
$LNG['plg_filter_active']			= 'Active';
$LNG['plg_filter_inactive']			= 'Inactive';
$LNG['plg_filter_new']				= 'Newly available';
$LNG['plg_section_installed']		= 'Installed Plugins';
$LNG['plg_none_installed']			= 'No plugins installed. Upload a ZIP or install a discovered plugin.';
$LNG['plg_deactivate']				= 'Deactivate';
$LNG['plg_activate']				= 'Activate';
$LNG['plg_admin_panel']				= 'Admin Panel';
$LNG['plg_uninstall']				= 'Uninstall';
$LNG['plg_uninstall_confirm']		= 'Really uninstall plugin \'{name}\'?\nThis action cannot be undone.';
$LNG['plg_section_discover']		= 'Found – not installed';
$LNG['plg_not_installed']			= 'Not installed';
$LNG['plg_install']					= 'Install';
$LNG['plg_upload_section']			= 'Install plugin via ZIP';
$LNG['plg_upload_title']			= 'Drag ZIP here or click to select';
$LNG['plg_upload_sub']				= 'Only <strong>.zip</strong> — must contain <code>manifest.json</code> with <code>id</code>, <code>name</code>, <code>version</code>';
$LNG['plg_upload_btn']				= 'Upload & Install';
$LNG['plg_hooks_title']				= 'Registered Hooks';
$LNG['plg_no_actions']				= 'No actions registered.';
$LNG['plg_no_filters']				= 'No filters registered.';
$LNG['plg_modal_cancel']			= 'Cancel';
$LNG['plg_modal_save']				= 'Save';
$LNG['plg_faq_open']				= '▼ Expand';
$LNG['plg_faq_close']				= '▲ Collapse';
$LNG['plg_copy']					= 'Copy';
$LNG['plg_copied']					= 'Copied!';
$LNG['plg_hooks_expand']			= '▼ Expand';

//----------------------------------------------------------------------------//
// SYSTEM DEBUG (SystemDebugPage.twig)
$LNG['sdp_safe_cleared']			= 'Safe-Mode lock successfully removed. Plugins will be reloaded on the next request.';
$LNG['sdp_safe_active']				= 'SAFE-MODE LOCK active';
$LNG['sdp_safe_all_disabled']		= 'ALL PLUGINS DISABLED';
$LNG['sdp_safe_since']				= 'Since:';
$LNG['sdp_safe_reason']				= 'Reason:';
$LNG['sdp_safe_remove_confirm']		= 'Really remove Safe-Mode lock? All plugins will be reloaded on the next request.';
$LNG['sdp_safe_remove_btn']			= '✖ Remove lock & re-enable plugins';
$LNG['sdp_tab_plugins']				= 'Plugins';
$LNG['sdp_tab_hooks']				= 'Hooks';
$LNG['sdp_tab_assets']				= 'Assets';
$LNG['sdp_tab_modules']				= 'Modules';
$LNG['sdp_no_plugins']				= 'No plugins found in the database.';
$LNG['sdp_no_hooks']				= 'No hooks registered.';
$LNG['sdp_no_assets']				= 'No assets registered.';
$LNG['sdp_copy']					= 'Copy';
$LNG['sdp_copied']					= '✓ Copied';
$LNG['sdp_plugin_search']			= 'Search plugin (ID, name, type)…';
$LNG['sdp_hook_search']				= 'Search hook (name, type, callback)…';
$LNG['sdp_asset_search']			= 'Search asset (path, plugin ID)…';
$LNG['sdp_module_search']			= 'Search module (ID, class, origin)…';
$LNG['sdp_no_module_manager']		= 'ModuleManager not loaded. The v2 Full Modular Gameplay Engine System is not active in this environment. Make sure <code>includes/classes/ModuleManager.class.php</code> is included in <code>common.php</code>.';
$LNG['sdp_no_modules']				= 'No modules registered.';

//----------------------------------------------------------------------------//
// SHOW INFORMATION (ShowInformationPage.twig)
$LNG['si_title']					= 'Server Information';
$LNG['si_subtitle']					= 'Technical details and environment variables';
$LNG['si_system_env']				= 'System Environment';
$LNG['si_db_game']					= 'Database & Game';
$LNG['si_paths']					= 'Paths & Settings';
$LNG['si_json']						= 'JSON Available';
$LNG['si_bcmath']					= 'BCMath Available';
$LNG['si_curl']						= 'cURL Available';
$LNG['si_game_addr']				= 'Game Address';
$LNG['si_game_path']				= 'Game Path';
$LNG['si_bug_report']				= 'Bug Report Template';
$LNG['si_copy_btn']					= 'Copy';
$LNG['si_copied_alert']				= 'Copied to clipboard!';

//----------------------------------------------------------------------------//
// SEND MESSAGES (SendMessagesPage.twig)
$LNG['sm_success_check']			= 'successful';
$LNG['sm_sent_check']				= 'sent';
$LNG['sm_next_btn']					= 'Continue';
$LNG['sm_error_title']				= '❌ ERROR';
$LNG['sm_error_msg']				= 'The message could not be delivered.';
$LNG['sm_retry']					= 'Retry';
$LNG['sm_cancel']					= 'Cancel';
$LNG['sm_bb_quote']					= 'Quote';
$LNG['sm_bb_link']					= 'Link';
$LNG['sm_bb_image']					= 'Image';
$LNG['sm_placeholder']				= 'Enter message here...';

//----------------------------------------------------------------------------//
// VARIOUS ADMIN SMALL STRINGS
$LNG['adm_select_area']				= 'Choose an area to edit';
$LNG['adm_mines_plants']			= 'Mines & Plants';
$LNG['adm_combat_ships']			= 'Combat & Civilian Ships';
$LNG['adm_guns_domes']				= 'Guns & Shield Domes';
$LNG['adm_tech_drives']				= 'Technologies & Drives';
$LNG['adm_dm_officers']				= 'DM Officers & Bonuses';
$LNG['adm_res_dm']					= 'Metal/Crystal/Deut & DM';
$LNG['adm_planet_fields']			= 'Fields, Names & Delete';
$LNG['adm_alliance_members']		= 'Members & Texts';
$LNG['adm_email_pw_name']			= 'Email, Password & Names';
$LNG['adm_buildings_edit_hint']		= 'Manipulate building levels';
$LNG['adm_select_player']			= 'Choose a player from the list or search directly.';
$LNG['adm_select_class']			= '-- Select class --';
$LNG['adm_news_color']				= 'Color';
$LNG['adm_news_size']				= 'Size';
$LNG['adm_select_btn']				= 'SELECT';
$LNG['adm_total']					= 'Total';