            ...
            case 1:
                ...
                foreach ($query as $StatRow)
                {
                    $RangeList[]	= array(
                        ...
                        // GEÄNDERT: shortly_number
                        'points'	=> shortly_number($StatRow[$Points]),
            ...
            case 2:
				...
				foreach ($query as $StatRow)
                {
                    $RangeList[]	= array(
                        ...
                        'rank'		=> $StatRow[$Rank],
                        // GEÄNDERT: shortly_number (2x)
                        'mppoints'	=> shortly_number(floor($StatRow[$Points] / $StatRow['ally_members'])),
                        'points'	=> shortly_number($StatRow[$Points]),
                        'ranking'	=> $StatRow[$OldRank] - $StatRow[$Rank],
                    );
                }
