...
/**
 * sm-relics – Plugin Bootstrap (v2 self-contained)
 *
 * Registers via plugin APIs (no files outside plugins/sm-relics/):
 *  1. Page route        → game.php?page=relics
 *  2. Admin route       → admin.php?page=relicsAdmin
 *  3. Twig namespace    → @sm-relics/game/relics.twig
 *  4. Cronjob path      → RelicsTick class in cron/RelicsTick.php
 *  5. Assets            → assets/css/relics.css, assets/js/relics.js
 *  6. ElementRegistry   → buildings 910-914
 *  7. game.planet       → 0-defaults for new planet columns
 *  8. Language          → $LNG['tech'][910..914]
 *  9. sidebar_end hook  → nav link injection
 *
 * The RelicsModule (GameModuleInterface) is auto-loaded by
 * PluginManager::loadPluginModules() via manifest["modules"].
 */
