...
/**
 * RelicsTick – sm-relics plugin cronjob
 *
 * Registered via: PluginManager::get()->registerCronjob('sm-relics', 'RelicsTick', 'cron/RelicsTick.php')
 * DB row: class = 'RelicsTick', name = 'relics_tick', min = '*/10'
 *
 * Every tick:
