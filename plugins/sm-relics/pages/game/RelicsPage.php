...
/**
 * RelicsPage – sm-relics ingame page controller
 *
 * Registered via: PluginManager::get()->registerPageRoute(...)
 * Route: game.php?page=relics
 *
 * Extends AbstractGamePage so it gets the full layout, navigation,
 * resource bar, and Twig rendering pipeline.
 *
 * Twig template: @sm-relics/game/relics.twig
 */
