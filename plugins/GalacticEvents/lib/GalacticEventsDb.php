...
/**
 * GalacticEventsDb – shared DB helper for the GalacticEvents plugin.
 *
 * All table names are built from DB_PREFIX at runtime so no changes to
 * core dbtables.php are needed.
 *
 * Table layout:
 *   {prefix}galactic_events          – event log (one row per event)
 *   {prefix}galactic_events_settings – single-row settings (id=1)
 */
